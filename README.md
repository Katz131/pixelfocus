...
1. Download the latest `pixelfocus-v3.19.12.zip` from the [Releases page](https://github.com/Katz131/pixelfocus/releases/latest).
...
5. Click **Load unpacked** and select the unzipped `pixelfocus-v3.19.12` folder.
