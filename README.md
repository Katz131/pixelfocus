...
1. Download the latest `pixelfocus-v3.19.10.zip` from the [Releases page](../../releases/latest).
...
5. Click **Load unpacked** and select the unzipped `pixelfocus-v3.19.10` folder.
