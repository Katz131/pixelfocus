...
(function() {
  ...
  var PROFILE_BADGES = [
    { id: 'early_bird_1', icon: '🐤', name: 'Early Bird' },
    { id: 'sleep_warrior', icon: '🛡️', name: 'Sleep Warrior' },
    { id: 'dream_weaver', icon: '🌀', name: 'Dream Weaver' },
    { id: 'night_master', icon: '🌙', name: 'Night Master' },
    { id: 'sleep_sage', icon: '🧘', name: 'Sleep Sage' },
    { id: 'lunar_legend', icon: '🌕', name: 'Lunar Legend' },
    { id: 'rest_royalty', icon: '👑', name: 'Rest Royalty' },
    { id: 'eternal_dreamer', icon: '💫', name: 'Eternal Dreamer' },
    { id: 'sleep_deity', icon: '✨', name: 'Sleep Deity' },
    { id: 'year_of_rest', icon: '📅', name: 'Year of Rest' },
    { id: 'sleep_olympian', icon: '🏅', name: 'Sleep Olympian' },
    { id: 'sleep_transcendent', icon: '🌌', name: 'Transcendent Sleeper' },
    { id: 'millennium_sleeper', icon: '🏛️', name: 'Millennium Sleeper' },
    { id: 'streak_sleep_3', icon: '🌟', name: 'Three-Peat' },
    { id: 'streak_sleep_5', icon: '✋', name: 'Handful of Dreams' },
    { id: 'streak_sleep_7', icon: '😴', name: 'Week of Zzz' },
    { id: 'streak_sleep_14', icon: '🌃', name: 'Fortnight Dreamer' },
    { id: 'streak_sleep_21', icon: '🧠', name: 'Habit Formed' },
    { id: 'streak_sleep_30', icon: '🌑', name: 'Monthly Moon' },
    { id: 'streak_sleep_45', icon: '🦾', name: 'Sleep Centurion' },
    { id: 'streak_sleep_60', icon: '🌆', name: 'Two-Month Twilight' },
    { id: 'streak_sleep_90', icon: '🌅', name: 'Quarter Dreamer' },
    { id: 'streak_sleep_120', icon: '🌎', name: 'Unwavering Night' },
    { id: 'streak_sleep_180', icon: '🎶', name: 'Half-Year Harmony' },
    { id: 'streak_sleep_270', icon: '🌸', name: 'Nine-Month Nirvana' },
    { id: 'streak_sleep_365', icon: '🏆', name: 'Perfect Sleep Year' },
    { id: 'pillow_pro', icon: '🛌', name: 'Pillow Professional' },
    { id: 'no_phone_zone', icon: '📵', name: 'No Phone Zone' },
    { id: 'melatonin_machine', icon: '💊', name: 'Melatonin Machine' },
    { id: 'first_focus', icon: '🧵', name: 'First Thread' },
    { id: 'five_sessions', icon: '🌱', name: 'Getting Started' },
    { id: 'ten_sessions', icon: '🏃', name: 'Shuttle Runner' },
    { id: 'twentyfive_sess', icon: '🎖️', name: 'Quarter Century' },
    { id: 'fifty_sessions', icon: '⚙️', name: 'Loom Veteran' },
    { id: 'century_focus', icon: '💯', name: 'Centurion' },
    { id: 'focus_250', icon: '🧲', name: 'Loom Addict' },
    { id: 'focus_500', icon: '🔥', name: 'Iron Will' },
    { id: 'focus_1000', icon: '🧨', name: 'Thousand Threads' },
    { id: 'focus_2500', icon: '🦾', name: 'Thread Titan' },
    { id: 'focus_5000', icon: '🌀', name: 'Five Thousand Fibers' },
    { id: 'focus_10000', icon: '🌌', name: 'Eternal Weaver' },
    { id: 'streak_3', icon: '🎩', name: 'Hat Trick' },
    { id: 'streak_7', icon: '📅', name: 'Weekly Weaver' },
    { id: 'streak_14', icon: '💪', name: 'Fortnight Focus' },
    { id: 'streak_21', icon: '🎯', name: 'Three-Week Weave' },
    { id: 'streak_30', icon: '📆', name: 'Monthly Master' },
    { id: 'streak_60', icon: '🥊', name: 'Bimonthly Boss' },
    { id: 'streak_90', icon: '👸', name: 'Quarterly Queen' },
    { id: 'streak_180', icon: '🦸', name: 'Half-Year Hero' },
    { id: 'streak_365', icon: '🏆', name: 'Full Year Focus' },
    { id: 'combo_3', icon: '⚡', name: 'Triple Threat' },
    { id: 'combo_5', icon: '🖐️', name: 'High Five' },
    { id: 'combo_10', icon: '⚡', name: 'Combo King' },
    { id: 'combo_15', icon: '💥', name: 'Combo Crusher' },
    { id: 'combo_20', icon: '😈', name: 'Combo Demon' },
    { id: 'combo_25', icon: '💎', name: 'Quarter-Century Combo' },
    { id: 'combo_50', icon: '🚀', name: 'Unstoppable' },
    { id: 'combo_100', icon: '🌟', name: 'Combo Deity' },
    { id: 'blocks_10', icon: '⏰', name: 'First Hour' },
    { id: 'blocks_50', icon: '💼', name: 'Half-Day Hustler' },
    { id: 'blocks_100', icon: '🧶', name: 'Century Cloth' },
    { id: 'blocks_250', icon: '📦', name: 'Bolt Maker' },
    { id: 'blocks_500', icon: '🏰', name: 'Loom Legend' },
    { id: 'blocks_1000', icon: '🏭', name: 'Thousand Bolts' },
    { id: 'blocks_2500', icon: '🛠️', name: 'Industrial Weaver' },
    { id: 'blocks_5000', icon: '🌍', name: 'Textile Empire' },
    { id: 'blocks_10000', icon: '🪐', name: 'Ten Thousand Threads' },
    { id: 'first_friend', icon: '🤝', name: 'Companion' },
    { id: 'social_duo', icon: '👯', name: 'Dynamic Duo' },
    { id: 'social_circle', icon: '🫂', name: 'Social Circle' },
    { id: 'social_squad', icon: '👪', name: 'Squad Goals' },
    { id: 'social_popular', icon: '😎', name: 'Popular' },
    { id: 'social_influencer', icon: '📱', name: 'Influencer' },
    { id: 'social_celebrity', icon: '🌟', name: 'Celebrity' },
    { id: 'social_famous', icon: '📸', name: 'Famous' },
    { id: 'social_icon', icon: '👑', name: 'Social Icon' },
    { id: 'social_mogul', icon: '💎', name: 'Social Mogul' },
    { id: 'profile_pic', icon: '🎨', name: 'Self-Portrait' },
    { id: 'display_name', icon: '🏷️', name: 'Named' },
    { id: 'full_profile', icon: '✅', name: 'Complete Profile' },
    { id: 'networker', icon: '🌐', name: 'Networker' },
    { id: 'party_starter', icon: '🎉', name: 'Party Starter' },
    { id: 'hype_crew', icon: '🥳', name: 'Hype Crew' },
    { id: 'social_butterfly', icon: '🦋', name: 'Social Butterfly' },
    { id: 'guild_leader', icon: '🏰', name: 'Guild Leader' },
    { id: 'level_3', icon: '🔰', name: 'Beginner' },
    { id: 'level_5', icon: '📖', name: 'Novice' },
    { id: 'level_10', icon: '📜', name: 'Apprentice' },
    { id: 'level_15', icon: '🎓', name: 'Sophomore' },
    { id: 'level_20', icon: '🔧', name: 'Skilled' },
    { id: 'level_25', icon: '🗡️', name: 'Journeyman' },
    { id: 'level_30', icon: '🔮', name: 'Adept' },
    { id: 'level_40', icon: '🎖️', name: 'Veteran' },
    { id: 'level_50', icon: '🏛️', name: 'Master' },
    { id: 'level_60', icon: '🧙', name: 'Sage' },
    { id: 'level_75', icon: '📕', name: 'Elder' },
    { id: 'level_100', icon: '🌟', name: 'Grandmaster' },
    { id: 'level_125', icon: '🏅', name: 'Legend' },
    { id: 'level_150', icon: '🐉', name: 'Mythic' },
    { id: 'level_200', icon: '🔥', name: 'Demigod' },
    { id: 'level_300', icon: '🌋', name: 'Titan' },
    { id: 'level_500', icon: '🪐', name: 'Transcendent' },
    { id: 'rich_100', icon: '💵', name: 'First Paycheck' },
    { id: 'rich_500', icon: '🪙', name: 'Pocket Change' },
    { id: 'rich_1000', icon: '💰', name: 'First Fortune' },
    { id: 'rich_5000', icon: '💳', name: 'Five Grand' },
    { id: 'rich_10000', icon: '💎', name: 'Textile Mogul' },
    { id: 'rich_25000', icon: '🤑', name: 'Quarter-Millionaire' },
    { id: 'rich_50000', icon: '🎰', name: 'Money Machine' },
    { id: 'rich_100000', icon: '🏦', name: 'Six Figures' },
    { id: 'rich_250000', icon: '🏰', name: 'Cloth Rothschild' },
    { id: 'rich_500000', icon: '💸', name: 'Half-Millionaire' },
    { id: 'rich_1000000', icon: '👑', name: 'Millionaire' },
    { id: 'hoard_1000', icon: '📥', name: 'Saver' },
    { id: 'hoard_5000', icon: '🧰', name: 'Thrifty' },
    { id: 'hoard_10000', icon: '🥚', name: 'Nest Egg' },
    { id: 'hoard_25000', icon: '📦', name: 'War Chest' },
    { id: 'hoard_50000', icon: '🐲', name: 'Dragon Hoard' },
    { id: 'hoard_100000', icon: '🦳', name: 'Scrooge' },
    { id: 'hoard_500000', icon: '🔒', name: 'Vault Keeper' },
    { id: 'gallery_1', icon: '🖼️', name: 'First Masterpiece' },
    { id: 'gallery_3', icon: '🎨', name: 'Small Exhibition' },
    { id: 'gallery_5', icon: '🖼️', name: 'Gallery Opening' },
    { id: 'gallery_10', icon: '🧑‍🎨', name: 'Curator' },
    { id: 'gallery_25', icon: '🏛️', name: 'Art Collector' },
    { id: 'gallery_50', icon: '🏟️', name: 'Museum Director' },
    { id: 'gallery_100', icon: '🌍', name: 'Louvre Rival' },
    { id: 'gallery_250', icon: '🎨', name: 'Prolific Painter' },
    { id: 'canvas_12', icon: '📐', name: 'Bigger Canvas' },
    { id: 'canvas_16', icon: '🎂', name: 'Sweet Sixteen' },
    { id: 'canvas_24', icon: '🖼️', name: 'Full Frame' },
    { id: 'canvas_32', icon: '📺', name: 'High Resolution' },
    { id: 'canvas_48', icon: '🖥️', name: 'Ultra Canvas' },
    { id: 'canvas_64', icon: '🤩', name: 'Pixel Perfectionist' },
    { id: 'dye_1', icon: '🌈', name: 'Color Curious' },
    { id: 'dye_3', icon: '🎨', name: 'Color Theory' },
    { id: 'dye_5', icon: '🧪', name: 'Master Dyer' },
    { id: 'dye_8', icon: '🪄', name: 'Chromatic Wizard' },
    { id: 'dye_10', icon: '🌌', name: 'Spectrum Lord' },
    { id: 'first_sale', icon: '💲', name: 'First Sale' },
    { id: 'first_hire', icon: '👤', name: 'First Hire' },
    { id: 'small_team', icon: '👥', name: 'Small Team' },
    { id: 'growing_team', icon: '📈', name: 'Growing Company' },
    { id: 'department', icon: '🏢', name: 'Department Head' },
    { id: 'corporation', icon: '🏢', name: 'Corporation' },
    { id: 'enterprise', icon: '🌍', name: 'Enterprise' },
    { id: 'conglomerate', icon: '🏰', name: 'Conglomerate' },
    { id: 'broker_unlocked', icon: '📉', name: 'Wall Street' },
    { id: 'first_stock', icon: '💹', name: 'First Investment' },
    { id: 'diversified', icon: '📊', name: 'Diversified' },
    { id: 'portfolio_5', icon: '📋', name: 'Portfolio Pro' },
    { id: 'survived_crash', icon: '💥', name: 'Crash Survivor' },
    { id: 'canvas_buyer_2', icon: '🛒', name: 'Canvas Shopper' },
    { id: 'canvas_buyer_3', icon: '🛒', name: 'Canvas Collector' },
    { id: 'canvas_buyer_5', icon: '🛒', name: 'Canvas Mogul' },
    { id: 'sales_100', icon: '💵', name: 'Art Dealer' },
    { id: 'sales_500', icon: '🏠', name: 'Gallery Owner' },
    { id: 'sales_1000', icon: '🏛️', name: 'Art Empire' },
    { id: 'sales_5000', icon: '🏟️', name: 'Auction House' },
    { id: 'sales_10000', icon: '💎', name: 'Art Magnate' },
    { id: 'blocks_25', icon: '🧵', name: 'Quarter Bolt' },
    { id: 'blocks_750', icon: '🏵️', name: 'Master Weaver' },
    { id: 'blocks_1500', icon: '💰', name: 'Textile Tycoon' },
    { id: 'blocks_3500', icon: '🗿', name: 'Cloth Colossus' },
    { id: 'blocks_7500', icon: '🏺', name: 'Fiber Pharaoh' },
    { id: 'combo_7', icon: '🍀', name: 'Lucky Seven' },
    { id: 'combo_30', icon: '📚', name: 'Thirty Stack' },
    { id: 'combo_75', icon: '🏃‍♂️', name: 'Marathon Mind' },
    { id: 'focus_75', icon: '🌙', name: 'Three Quarters' },
    { id: 'focus_150', icon: '🎉', name: 'Sesquicentennial' },
    { id: 'focus_750', icon: '🛡️', name: 'Relentless' },
    { id: 'level_7', icon: '🍀', name: 'Lucky Level' },
    { id: 'level_35', icon: '💼', name: 'Mid-Career' },
    { id: 'level_90', icon: '🏁', name: 'Almost There' },
    { id: 'level_175', icon: '🦹', name: 'Overlord' },
    { id: 'level_250', icon: '🌌', name: 'Quarter Thousand' },
    { id: 'level_400', icon: '🪐', name: 'Ascendant' },
    { id: 'streak_sleep_10', icon: '🌚', name: 'Ten Straight' },
    { id: 'streak_sleep_50', icon: '🌠', name: 'Fifty Nights' },
    { id: 'sleep_75', icon: '🌍', name: 'Seventy-Five' },
    { id: 'sleep_100', icon: '💯', name: 'Century Sleeper' },
    { id: 'sleep_125', icon: '🎓', name: 'Sleep Scholar' },
    { id: 'sleep_250', icon: '🤴', name: 'Sleep Monarch' },
    { id: 'sleep_400', icon: '🏯', name: 'Sleep Emperor' },
    { id: 'gallery_2', icon: '🖌️', name: 'Second Canvas' },
    { id: 'gallery_15', icon: '🏛️', name: 'Mini Museum' },
    { id: 'gallery_75', icon: '🖼️', name: 'Prolific Creator' },
    { id: 'canvas_10', icon: '📏', name: 'First Upgrade' },
    { id: 'social_trio', icon: '👨‍👧‍👦', name: 'The Trio' },
    { id: 'social_crew_6', icon: '🛶', name: 'Full Crew' },
    { id: 'social_army', icon: '🛡️', name: 'Small Army' },
    { id: 'sales_250', icon: '🏪', name: 'Art Merchant' },
    { id: 'sales_2500', icon: '💰', name: 'Canvas Capitalist' },
    { id: 'canvas_buyer_4', icon: '📦', name: 'Canvas Hoarder' },
    { id: 'rich_2500', icon: '🛋️', name: 'Comfortable' },
    { id: 'rich_75000', icon: '💴', name: 'Almost Six Figs' },
    { id: 'hoard_2500', icon: '🐖', name: 'Piggy Bank' },
    { id: 'hoard_75000', icon: '🏦', name: 'Fort Knox' },
    { id: 'hoard_250000', icon: '💠', name: 'Untouchable Wealth' },
    { id: 'streak_5', icon: '📚', name: 'School Week' },
    { id: 'streak_10', icon: '💪', name: 'Ten-Day Tenacity' },
  ];
