  ...
  function load(cb) {
    chrome.storage.local.get(['pixelFocusState', 'pixelFocusState_backup_safe', 'pixelFocusState_backup_safe2', 'pixelFocusProfileId'], (result) => {
      ...
      if (_loaded) {
        ...
        window._pixelState = state; // expose for tutorial-ui.js
        window.saveState = function() { save(); }; // expose save for tutorial-ui.js
  ...
  function init() {
    ...
    setTimeout(function() {
      ...
      (function initFriendsUI() {
        ...
        // v3.23.240: Open morse demo for tutorial
...
// Tutorial UI moved to tutorial-ui.js
