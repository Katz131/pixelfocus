// cold-turkey-host-wrapper.cs — Invisible native messaging host wrapper
// Launches cold-turkey-host.ps1 via PowerShell with no visible window,
...
class ColdTurkeyHostWrapper
{
    static void Main()
    {
        string exeDir = Path.GetDirectoryName(
            System.Reflection.Assembly.GetExecutingAssembly().Location);
        string ps1 = Path.Combine(exeDir, "cold-turkey-host.ps1");
