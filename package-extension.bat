...
REM It will create "pixelfocus-v3.19.17.zip" right next to itself
...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
  ...
  "$files = @('manifest.json','background.js','popup.html','app.js','gallery.html','gallery.js','factory.html','factory.js','ratiocinatory.html','ratiocinatory.js','stage-entries.js','msglog.js','sounds.js','tips.js','tooltip.js','fonts.css');" ^
...
if errorlevel 1 (
    ...
    echo   %~dp0pixelfocus-v3.19.17.zip
    echo.
